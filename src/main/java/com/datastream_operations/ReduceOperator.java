...
public class ReduceOperator {
    public static void main(String[] args) throws Exception {
        ...
        // month, avg. profit
        DataStream<Tuple2<String, Double>> profitPerMonth = reduced.map((MapFunction<Tuple5<String, String, String, Integer, Integer>, Tuple2<String, Double>>) input -> new Tuple2<String, Double>(input.f0, new Double((input.f3 * 1.0) / input.f4)));
