...
public class ReduceOperator {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> avgData = env.readTextFile("/Users/vinzee/code/apache-flink-playground/src/main/java/com/datastream_api/avg.txt");

        // month, product, category, profit, count
        DataStream<Tuple5<String, String, String, Integer, Integer>> mapped = avgData.map(new Splitter());      // tuple  [June,Category5,Bat,12,1]
        ...
        DataStream<Tuple2<String, Double>> profitPerMonth = reduced
                .map((MapFunction<Tuple5<String, String, String, Integer, Integer>, Tuple2<String, Double>>) input -> {
