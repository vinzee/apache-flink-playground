...
public class Broadcast {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple2<String, Integer>> employees = env
                .readTextFile("/home/jivesh/broadcast.txt")
                .map((MapFunction<String, Tuple2<String, String>>) value -> {
                    // dept, data
                    // {(Purchase), (AXPM175755,Nana,Developer,Purchase,GH67D)}
                    return new Tuple2<>(value.split(",")[3], value);
                })
                .keyBy(0)
